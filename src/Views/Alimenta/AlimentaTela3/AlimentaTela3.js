...
const AlimentaTela3: () => React$Node = () => {
  return (
    <Fragment>
      <Cabecalho/>
      <View>
        ...
        >
          ...
          >
              <View style = {styles.buttonNovoFrasco}
                    >
                  <Text style = {styles.textNovoFrasco}>Nova</Text>
                  <Text style = {styles.textNovoFrasco}>Ração</Text>
              </View>
          </TouchableOpacity>
          <TouchableOpacity 
          ...
          >
              <View style = {styles.buttonFimVacina}
                    >
                  <Text style = {styles.textFimVacina}>Fim da</Text>
                  <Text style = {styles.textFimVacina}>alimentação</Text>
              </View>
          </TouchableOpacity>
        </View>
      </View>
